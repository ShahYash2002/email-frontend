            ...
            >
              ...
              >
                ...
                >
                  ...
                  <td class="flex justify-end flex-wrap gap-y-2 p-4 space-x-2 whitespace-nowrap">
                    <router-link
                      :to="{
            ...
            <form action="#">
              <div class="grid grid-cols-6 gap-6">
                ...
                <div class="col-span-6">
                  ...
                  >
👨&zwj;💻Full-stack web developer. Open-source contributor.</textarea
                  >
                </div>
              </div>
            </form>
    ...
    <!-- Add User Modal -->
    <div
      class="fixed left-0 right-0 z-50 items-center justify-center overflow-x-hidden overflow-y-auto top-4 md:inset-0 h-modal sm:h-full hidden"
      id="add-user-modal"
      aria-hidden="true"
    >
      <div class="relative w-full h-full max-w-2xl px-4 md:h-auto">
