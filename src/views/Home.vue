<template>
  <div class="">
    ...
    <!-- <div class="flex flex-wrap justify-center md:justify-around gap-4 mb-8 ">
      ...
      >
        ...
        <div class="flex items-baseline mt-4 space-x-6">
          <div
            class="w-full bg-gray-200 rounded-t-lg h-36 dark:bg-gray-700"
          ></div>
          <div
          ...
          ></div>
          <div
            class="w-full h-32 bg-gray-200 rounded-t-lg dark:bg-gray-700"
          ></div>
          <div
            class="w-full bg-gray-200 rounded-t-lg h-40 dark:bg-gray-700"
          ></div>
          <div
            class="w-full bg-gray-200 rounded-t-lg h-36 dark:bg-gray-700"
          ></div>
    ...
    <div
      role="status"
      class="max-w-100 p-4 space-y-4 border border-gray-200 divide-y divide-gray-200 rounded shadow animate-pulse dark:divide-gray-700 md:p-6 dark:border-gray-700"
    >
